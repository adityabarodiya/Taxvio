// app/state/haryana/gst-services/[city]/page.tsx
...
export async function generateMetadata(
  ...
  return {
    title: `GST Registration & Return Filing in ${areaName}, Haryana | Taxvio`,
    description: `Expert GST registration, GSTR-1/GSTR-3B filing, GST refund, LUT filing, GSTIN verification, e-commerce GST and freelancer GST in ${areaName}, ${district}, Haryana. CA-assisted, 100% online, starting ₹1,499. Get your GSTIN in 3–7 days.`,
    keywords: [
      `GST registration ${areaName}`,
      `GST return filing ${areaName} Haryana`,
      `GSTIN ${areaName} ${district}`,
      `GST consultant ${areaName} Haryana`,
      `GST refund ${areaName}`,
      `GST for e-commerce ${areaName}`,
      `GST for freelancers ${areaName}`,
      `GSTIN verification ${areaName}`,
      `online GST ${areaName} Haryana`,
      `CA GST services ${district}`,
    ],
    alternates: { canonical: `https://www.taxvio.in/state/haryana/gst-services/${city}` },
    openGraph: {
      title: `GST Services in ${areaName}, Haryana | Taxvio`,
      description: `GST registration, GSTR filing, refund, LUT, e-commerce & freelancer GST in ${areaName}, ${district}, Haryana — CA-assisted, from ₹1,499.`,
      url: `https://www.taxvio.in/state/haryana/gst-services/${city}`,
      siteName: "Taxvio",
      type: "website",
    },
    twitter: { card: "summary_large_image", title: `GST Services in ${areaName}, Haryana | Taxvio` },
  ...
  return [
    ...
    /* ── 1. GST Registration ── */
    {
      ...
      features: [
        ...
        "All Haryana GST jurisdictions covered",
      ],
      seoContent: `GST registration is mandatory in ${areaName}, ${district}, Haryana for any business whose annual turnover crosses ₹40 lakh (goods) or ₹20 lakh (services), or that supplies goods/services interstate, sells through e-commerce marketplaces, or falls under any notified category — regardless of turnover. Taxvio provides complete GST registration for businesses in ${areaName} with GSTIN typically issued within 3–7 working days.

A registered GSTIN allows your ${areaName} business to legally charge GST on invoices, claim Input Tax Credit on business purchases, and be eligible for B2B contracts that require tax invoices. Without it, you cannot issue GST-compliant invoices, and any B2B buyer purchasing from you cannot claim ITC — a serious commercial disadvantage in Haryana's manufacturing-driven and B2B-heavy economy spanning automobile parts, textiles, IT services, and industrial goods.
...
Whether your ${areaName} business is a small retail shop, a manufacturing unit, a wholesale trading firm, or a growing IT services company, our reconciliation-first approach to GST return filing means fewer notices, accurate ITC claims, and a clean compliance history — which matters directly for loan eligibility, government tenders, and vendor onboarding with larger corporate buyers across Haryana's industrial clusters.`,
    },
    ...
    /* ── 3. GST Refund Application ── */
    {
      ...
      seoContent: `A GST refund becomes due in ${areaName}, ${district}, Haryana whenever accumulated Input Tax Credit exceeds the GST liability paid on outward supplies — most commonly for exporters, businesses with an inverted duty structure (input tax rate higher than output tax rate), or those with excess balance in the electronic cash ledger. Under Section 54 of the CGST Act, refund applications must be filed within 2 years of the relevant date, and the GST department is statutorily required to process eligible refunds within 60 days.

Taxvio's GST refund service for ${areaName} businesses starts with a detailed eligibility and quantum analysis — calculating the exact refundable amount using the formula prescribed under Rule 89, whether your case involves zero-rated exports (with IGST paid, refunded automatically via shipping bill data matched to ICEGATE) or exports under LUT (requiring manual RFD-01 filing for accumulated ITC). For ${areaName} manufacturers and traders with an inverted duty structure — common in textile processing, certain automobile component manufacturing, and several retail categories — we compute the refund eligible on input goods versus output supply rates.
...
We also assist ${areaName} businesses whose GSTIN was cancelled suo motu by the department for non-filing — a frequent issue for dormant or seasonal businesses. Revocation requires filing Form REG-21 within 30 days of the cancellation order, along with clearance of all pending returns and dues. Operating with a cancelled GSTIN means you cannot issue valid tax invoices and your buyers cannot claim ITC on purchases from you — making prompt revocation critical for businesses that intend to continue operating.`,
    },
...
For ${areaName} businesses with annual turnover exceeding ₹5 crore, GSTR-9C — a reconciliation statement comparing audited financial statements against GSTR-9 figures, certified by a Chartered Accountant — is additionally mandatory. Late filing of GSTR-9 attracts a penalty of ₹200 per day (₹100 each under CGST and SGST), capped at 0.25% of turnover in the relevant state — making timely filing a meaningful cost-avoidance exercise, not just a compliance formality.`,
    },
    ...
    /* ── 9. GST Notice Reply ── */
    {
      ...
      seoContent: `GST notices are increasingly common for businesses in ${areaName}, ${district}, Haryana as the department's data analytics flag discrepancies between filed returns — and the most frequent type, ASMT-10 (scrutiny notice), is typically issued for mismatches between GSTR-1 and GSTR-3B, excess ITC claimed beyond what GSTR-2B shows as eligible, or turnover reported in GST returns not matching income tax or e-way bill data. Responding within the 30-day window is critical: ignoring an ASMT-10 leads to assessment under Section 62, resulting in a best-judgement tax demand that is significantly harder to contest after the fact.
...
We compile all required documentation — sales registers, purchase registers, stock records, e-way bills, bank statements — into the format the auditing officer expects, draft responses to specific audit queries (ADT-01 notices and subsequent communications), and represent your ${areaName} business in coordination meetings with the audit team throughout the process. If the audit results in a demand notice (typically issued as ADT-02 followed by formal proceedings under Section 73/74), we seamlessly transition into demand response and, if necessary, appellate representation — ensuring continuity of defence rather than starting fresh with a new advisor mid-process.`,
    ...
    /* ── 11. GST E-Invoicing Setup ── */
    {
      ...
      seoContent: `E-invoicing is mandatory for GST-registered businesses in ${areaName}, ${district}, Haryana with aggregate annual turnover above ₹5 crore (a threshold progressively lowered from ₹500 crore at launch in 2020 to ₹5 crore from August 2023) — meaning a steadily growing number of mid-sized manufacturers, traders, and service providers across Haryana's industrial and commercial zones now fall under this requirement. Under e-invoicing, every B2B invoice must be registered on the government's Invoice Registration Portal (IRP) within 30 days of issue, which generates a unique Invoice Reference Number (IRN) and QR code that must appear on the printed or digital invoice. Invoices without a valid IRN are not legally valid tax invoices, and buyers cannot claim ITC against them.
...
A significant practical benefit for ${areaName} businesses adopting e-invoicing properly is the dramatic reduction in GSTR-1 filing effort — since e-invoice data auto-populates into your GSTR-1, the manual invoice entry burden largely disappears, and discrepancy risk between your issued invoices and filed returns drops substantially. We also set up exception handling for cancelled invoices, credit/debit notes, and bulk upload scenarios common in high-volume Haryana manufacturing and distribution businesses.`,
    ...
    /* ── 12. GST for E-Commerce Sellers & Operators ── */
    {
      ...
      seoContent: `GST compliance for e-commerce sellers and operators in ${areaName}, ${district}, Haryana has unique requirements beyond standard GST registration — driven by the Tax Collected at Source (TCS) mechanism under Section 52, which requires every e-commerce operator (Amazon, Flipkart, Meesho, etc.) to deduct 1% TCS on the net value of taxable supplies made through their platform and deposit it with the government on the seller's behalf. Sellers operating from ${areaName} — particularly those in Haryana's expanding warehouse and fulfillment corridor spanning Gurgaon, Manesar, Kundli, and Bahadurgarh — must claim this TCS as credit against their GST liability, which requires careful reconciliation between marketplace settlement reports and GSTR-3B filings.
...
For ${areaName} businesses that are themselves e-commerce operators (not just sellers) — including platforms facilitating other sellers' transactions — we handle GSTR-8 filing, the specific return for TCS collected and deposited. We also advise restaurant and food businesses in ${areaName} on Section 9(5) compliance, under which platforms like Zomato and Swiggy are deemed the supplier for GST purposes on certain restaurant services, shifting tax liability and invoicing responsibility in ways that frequently confuse new sellers onboarding to these platforms.`,
    ...
    /* ── 13. GST for Freelancers & Independent Professionals ── */
    {
      ...
      seoContent: `${areaName}, as part of Haryana's rapidly growing freelance and independent-professional economy — particularly concentrated in Gurgaon's IT corridor and emerging startup zones — hosts a large population of software developers, designers, content writers, consultants, and digital marketers. Many are unaware that GST registration becomes mandatory once aggregate annual turnover (including domestic and export billing) exceeds ₹20 lakh, even when most or all income comes from foreign clients. A common and costly misconception among ${areaName} freelancers is believing that billing only foreign clients exempts them from GST registration — it does not; it only changes how GST is applied (zero-rated, with LUT, rather than charged to the client).
...
export default async function HaryanaGSTAreaPage(
  ...
  const WA = `https://wa.me/${PHONE}?text=${encodeURIComponent(`Hello Taxvio, I need GST services in ${areaName}, ${district}, Haryana.`)}`;
  ...
  const localBusinessSchema = {
    ...
    description: `Taxvio provides GST registration, GSTR-1/GSTR-3B filing, refund, LUT, e-commerce GST and freelancer GST services in ${areaName}, ${district}, Haryana.`,
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "GST Haryana",   item: "https://www.taxvio.in/state/haryana/gst-services" },
      { "@type": "ListItem", position: 3, name: district,        item: `https://www.taxvio.in/state/haryana/gst-services#${district.toLowerCase()}` },
      { "@type": "ListItem", position: 4, name: `${areaName} GST`, item: `https://www.taxvio.in/state/haryana/gst-services/${city}` },
    ],
  };
  ...
  const serviceListSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: `GST Services in ${areaName}, Haryana`,
    numberOfItems: services.length,
    itemListElement: services.map((s, i) => ({
      "@type": "ListItem",
      position: i + 1,
      name: s.title,
      url: `https://www.taxvio.in/state/haryana/gst-services/${city}#${s.slug}`,
    })),
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: `How long does GST registration take in ${areaName}, Haryana?`,
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-16 pb-10 md:pt-24 md:pb-14">
            ...
            <nav className="mb-7">
              <ol className="flex flex-wrap items-center gap-1.5 text-xs text-white/45">
                {[
                  { href: "/", label: "Home" },
                  { href: "/state/haryana/gst-services", label: "GST — Haryana" },
            ...
            <div className="grid md:grid-cols-[1fr_300px] gap-10 items-start">
              ...
              <div>
                <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold mb-5 backdrop-blur-sm"
                  ...
                  {areaName}, {district} · Haryana · GST Services
                </div>
        ...
        <section className="py-20 bg-white border-y border-gray-100">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                { icon: Users,       title: "CA-Certified GST Professionals", desc: `Every GST service for ${areaName} businesses is handled by practising CAs — not data entry agents. We understand Haryana GST jurisdiction and processing patterns for ${district}.`, color: "bg-blue-100 text-blue-700" },
        ...
        <section className="py-16 bg-white border-b border-gray-100">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="space-y-3" itemScope itemType="https://schema.org/FAQPage">
              {[
                {
                  q: `How long does GST registration take in ${areaName}, Haryana?`,
            ...
            <div className="max-w-6xl mx-auto px-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <h2 className="text-lg font-extrabold text-gray-800">GST Services in Nearby Haryana Areas</h2>
                </div>
              </div>
              <div className="flex flex-wrap gap-3">
                {regionAreas.map((c) => (
                  <Link key={c.name}
                    href={`/state/haryana/gst-services/${slugifyArea(c.name)}`}
                ...
                <Link href="/state/haryana/gst-services"
