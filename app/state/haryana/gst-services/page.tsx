// app/state/haryana/gst-services/page.tsx
...
export const metadata: Metadata = {
  title: "GST Registration & Return Filing Services Across Haryana | Taxvio",
  description:
    "Taxvio provides expert GST registration, GSTR-1/GSTR-3B filing, GST refund, LUT filing, e-commerce GST, freelancer GST, and notice reply across 200+ areas in Haryana — Gurgaon, Faridabad, Ambala, Karnal, Panipat, Sonipat & more. CA-assisted, 100% online, starting ₹1,499.",
  keywords: [
    "GST registration Haryana",
    "GST services Haryana areas",
    "GST consultant Haryana",
    "GST return filing Haryana",
    "GSTIN registration Haryana",
    "GST Gurgaon Faridabad Ambala Karnal",
    "GST for e-commerce Haryana",
    "GST for freelancers Haryana",
    "Taxvio Haryana GST",
    "GST search verification Haryana",
  ],
  alternates: { canonical: "https://www.taxvio.in/state/haryana/gst-services" },
  openGraph: {
    title: "GST Services Across 200+ Haryana Areas | Taxvio",
    description: "Expert GST registration, return filing, refund, LUT & e-commerce GST across all Haryana areas — CA-assisted, from ₹1,499.",
    url: "https://www.taxvio.in/state/haryana/gst-services",
    siteName: "Taxvio",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "GST Services Across Haryana | Taxvio",
    description: "GST registration & filing across 200+ Haryana areas — from ₹1,499.",
  },
...
const SEO_SECTIONS = [
  {
    heading: "GST Registration Services Across Haryana",
    body: `Haryana is one of India's most industrialized and economically advanced states, home to major corporate hubs like Gurgaon (Gurugram) and Faridabad, industrial clusters in Sonipat, Panipat, and Bahadurgarh, automobile manufacturing in Manesar and Dharuhera, IT and service sectors across the NCR belt, and extensive agricultural trade networks spanning all 22 districts. From the automotive ancillaries of Faridabad Industrial Township to the textile markets of Panipat, the grain mandis of Karnal and Kaithal, the IT parks of Cyber City Gurgaon, and the wholesale trading hubs of Ambala and Hisar — every business operating from a Haryana address must register for GST once it crosses the prescribed turnover threshold or engages in interstate/e-commerce supply.

Taxvio provides end-to-end GST registration across all 200+ areas of Haryana — from Tier-1 corporate hubs like Gurgaon, Faridabad, and Ambala, to rapidly growing cities like Panipat, Karnal, Sonipat, and Rohtak, down to emerging towns like Bahadurgarh, Rewari, Jhajjar, and Mahendragarh. Our CA team handles eligibility assessment, document preparation, ARN generation, Aadhaar-based authentication, and GSTIN follow-up — entirely online, typically within 3–7 working days, regardless of which Haryana district your registered office falls under.`,
  },
  {
    heading: "GST for E-Commerce Sellers and Freelancers in Haryana",
    body: `Haryana hosts one of India's fastest-growing concentrations of e-commerce sellers, D2C brands, and freelance professionals — particularly across the NCR belt spanning Gurgaon, Faridabad, Sonipat, and Bahadurgarh. E-commerce sellers operating warehouses and fulfillment centers in areas like IMT Manesar, Kundli Industrial Area, and Faridabad NIT need GST registration that accounts for marketplace-specific GSTIN requirements, monthly GSTR-1/GSTR-3B filing reconciled against Amazon, Flipkart, and Meesho settlement reports, TCS credit matching under Section 52, and GSTR-8 compliance for businesses also operating as e-commerce operators.

Haryana's burgeoning freelance and consulting economy — concentrated in Gurgaon's Cyber City, DLF Phase 1–5, Sohna Road, and Golf Course Road corridors — has equally specific GST needs: registration, LUT filing under Form RFD-11 for professionals billing foreign clients without IGST, correct SAC code mapping for IT, design, consulting, and engineering services, ITC claims on laptops and software subscriptions, and Reverse Charge Mechanism review for foreign SaaS subscriptions. Taxvio's Haryana team handles both segments with the specialized expertise these niche compliance areas demand.`,
  },
  {
    heading: "Why Haryana Businesses Across Every District Choose Taxvio",
    body: `Haryana's 22 districts each have distinct commercial profiles — corporate and IT services in Gurgaon and Faridabad, automobile and manufacturing in Manesar and Dharuhera, textile and carpet manufacturing in Panipat and Karnal, grain and agri-trade in Ambala, Kurukshetra, and Jind, and retail and wholesale distribution across Hisar, Rohtak, and Bhiwani. GST compliance needs differ accordingly: an automobile parts manufacturer in IMT Manesar needs accurate HSN classification and ITC reconciliation on raw material imports, while a SaaS startup in Cyber City Gurgaon needs export invoice classification and LUT renewal tracking.

Taxvio's GST team has filed applications and returns for clients across nearly every Haryana GST jurisdiction — from the Gurgaon Commissionerate to the Ambala and Hisar divisions — giving us first-hand familiarity with Haryana GST department processing patterns, common query types, and the documentation nuances that speed up approvals. Our WhatsApp-first service model means a textile trader in Panipat and a startup founder in Golf Course Road receive the exact same CA-quality, same-day response — with transparent pricing and zero office visits required.`,
  },
];
...
const itemListSchema = {
  ...
  "@type": "ItemList",
  name: "Haryana Areas — GST Services | Taxvio",
  numberOfItems: HARYANA_AREAS.length,
  itemListElement: HARYANA_AREAS.map((c, i) => ({
    "@type": "ListItem",
    position: i + 1,
    name: `${c.name} — GST Services`,
    url: `https://www.taxvio.in/state/haryana/gst-services/${slugifyArea(c.name)}`,
  })),
};
...
function MajorAreaCard({ name, district, region }: { name: string; district: string; region: string }) {
  return (
    <Link href={`/state/haryana/gst-services/${slugifyArea(name)}`}
      aria-label={`GST services in ${name}, Haryana`}
...
/* ─── Page ─────────────────────────────────────────────────────────────────── */
export default function HaryanaGSTIndexPage() {
  return (
    <>
      <Script id="haryana-gst-schema" type="application/ld+json"
      ...
      <main className="bg-[#f8fbfd] text-gray-800 font-sans">
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-10 md:pt-28 md:pb-14">
            <nav className="mb-8">
              <ol className="flex items-center gap-2 text-xs text-white/50">
                ...
                <li className="text-white/70 font-medium">GST Services — Haryana</li>
              </ol>
            </nav>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold mb-6 backdrop-blur-sm"
                  ...
                  Haryana · 200+ Areas · GST Only · 100% Online
                </div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3">
                  <a href="https://wa.me/918937980366?text=Hello%20Taxvio%2C%20I%20need%20GST%20help%20in%20Haryana."
              ...
              <div className="hidden md:block">
                <p className="text-xs uppercase tracking-widest text-white/40 font-bold mb-4">GST services in every Haryana area</p>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <h2 className="text-xl md:text-2xl font-extrabold text-gray-800">GST Services in Key Haryana Cities</h2>
              </div>
            </div>
        ...
        <section className="py-12 bg-white border-y border-gray-100">
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="text-[11px] font-bold uppercase tracking-widest text-emerald-600">Emerging Cities & Towns</p>
                <h2 className="text-xl font-extrabold text-gray-800">GST Services in Haryana Industrial & Commercial Areas</h2>
              </div>
            </div>
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
              {TIER2_AREAS.slice(0, 30).map((c) => (
                <Link key={c.name} href={`/state/haryana/gst-services/${slugifyArea(c.name)}`}
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-[#00416a] mt-4">
                GST Services — All Haryana Areas by Region
              </h2>
            </div>
        ...
        <section className="py-20 bg-white border-y border-gray-100">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-[#00416a] mt-4">
                All GST Services Available Across Every Haryana Area
              </h2>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5">
              {[
                { title:"GST Registration", price:"₹1,499", href:"/serviceslist/gst/gst-registration", icon:"🧾", color:"bg-emerald-50 border-emerald-100",
                  points:["GSTIN in 3–7 working days", "Eligibility consultation included", "Aadhaar OTP-based e-KYC", "All Haryana GST jurisdictions"] },
        ...
        <section className="py-16 bg-[#00416a]">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-10">
              <h2 className="text-2xl font-extrabold text-white">All Haryana Areas — GST Services</h2>
              ...
              <div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="flex-1">
                  ...
                  <h2 className="text-2xl md:text-3xl font-extrabold text-white leading-tight">
                    GST Registration & Filing — Wherever You Are in Haryana
                  </h2>
                  <p className="text-white/65 text-sm mt-3 max-w-lg leading-relaxed">
                    100% online. Same-day WhatsApp response. Our CA team serves every Haryana area — Gurgaon to Mahendragarh. Starting ₹1,499.
                  </p>
                </div>
