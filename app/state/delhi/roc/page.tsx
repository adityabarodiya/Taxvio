...
export const metadata: Metadata = {
  title: "Company Registration & ROC Compliance Services Across Delhi | Taxvio",
  description:
    "Taxvio provides expert Private Limited, LLP, OPC & Section 8 Company formation; annual ROC compliance (AOC-4, MGT-7); director appointment/resignation; company name change; authorised capital increase; and company closure/strike-off across 300+ areas in Delhi — Connaught Place, Karol Bagh, Nehru Place, Dwarka, Rohini, Saket & more. CA-assisted, 100% online, starting ₹3,999.",
  keywords: [
    "company registration Delhi",
    "private limited company Delhi areas",
    "LLP registration Delhi",
    "ROC compliance Delhi",
    "OPC registration Delhi",
    "Section 8 company Delhi",
    "annual ROC filing AOC-4 MGT-7 Delhi",
    "company name change Delhi",
    "company strike off Delhi",
    "Taxvio Delhi ROC",
  ],
  alternates: { canonical: "https://www.taxvio.in/state/delhi/roc" },
  openGraph: {
    title: "ROC & Company Registration Services Across 300+ Delhi Areas | Taxvio",
    description: "Expert company formation, annual ROC compliance, director changes & company closure across all Delhi areas — CA-assisted, from ₹3,999.",
    url: "https://www.taxvio.in/state/delhi/roc",
    siteName: "Taxvio",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "ROC & Company Registration Across Delhi | Taxvio",
    description: "Company formation, LLP, OPC, annual ROC compliance across 300+ Delhi areas — from ₹3,999.",
  },
...
const SEO_SECTIONS = [
  {
    heading: "Company Registration Services Across Delhi",
    body: `Delhi is India's most concentrated corporate ecosystem outside Mumbai — anchored by the startup and consulting clusters in Saket, Hauz Khas, and Greater Kailash, the trading and wholesale companies headquartered around Karol Bagh, Sadar Bazar, and Chandni Chowk, the corporate office towers of Nehru Place and Connaught Place, and a fast-growing density of small business incorporations across every residential-commercial pocket of the capital. Whatever the structure — Private Limited, LLP, OPC, or Section 8 non-profit — every entity incorporated by a Delhi-based promoter falls under the jurisdiction of the Registrar of Companies, Delhi (RoC Delhi), one of the busiest ROC offices in the country.

Taxvio handles complete company formation across all 300+ areas of Delhi — from Tier-1 commercial hubs like Connaught Place, Nehru Place, and Karol Bagh, to established residential-commercial localities like Rohini, Janakpuri, and Mayur Vihar, down to outer growth corridors like Najafgarh, Dwarka, and Narela. Our MCA-registered CA team manages the complete SPICe+ incorporation process — name reservation, DIN and DSC procurement, MOA/AOA drafting, and PAN/TAN application — typically completing standard Private Limited and OPC incorporations within 7–10 working days.`,
  },
  {
    heading: "Annual ROC Compliance and Corporate Maintenance for Delhi Companies",
    body: `Every company and LLP registered through RoC Delhi carries recurring annual compliance obligations that continue for the entity's entire operational life — AOC-4 (financial statements) due within 30 days of AGM, MGT-7 (annual return) due within 60 days of AGM, with the AGM itself required within 6 months of financial year end. LLPs face a parallel but separate timeline: Form 11 (annual return) by May 30 and Form 8 (statement of accounts) by October 30. Given Delhi's dense concentration of small and mid-sized companies, missed ROC deadlines and the resulting additional fees and director disqualification risk are among the most common compliance issues our Delhi clients bring to us.

Taxvio's annual ROC compliance service for Delhi companies covers complete financial statement preparation, board and AGM minute drafting, AOC-4 and MGT-7 filing, DIN KYC (DIR-3 KYC) for all directors, and equivalent LLP Form 11/8 management — keeping your company's RoC Delhi record consistently ACTIVE and your directors' DINs free of disqualification risk.`,
  },
  {
    heading: "Why Delhi Businesses Across Every District Choose Taxvio",
    body: `Delhi's company formation activity spans a remarkable range of business models — tech and SaaS startups incorporating in South Delhi's innovation corridors, family-run trading businesses formalising decades-old proprietorships into Private Limited structures in Old Delhi's wholesale markets, single-founder consultancies opting for OPC structures across the capital, and NGOs and social enterprises pursuing Section 8 registration to access CSR and grant funding. Each segment interacts with RoC Delhi differently, and understanding the office's specific processing patterns, common name-approval objections, and documentation expectations materially speeds up incorporation and reduces resubmission cycles.

Taxvio's ROC team has filed incorporation and compliance documents with RoC Delhi for clients across nearly every Delhi district — from the Central and North Delhi wholesale belt to the South and South West Delhi startup and residential corridors. Our WhatsApp-first model means a trading firm incorporating in Sadar Bazar and a tech startup incorporating in Hauz Khas receive the exact same CA-quality, same-day response — with transparent, all-inclusive pricing and zero office visits required for any of our nine ROC services.`,
  },
];
...
const itemListSchema = {
  ...
  "@type": "ItemList",
  name: "Delhi Areas — ROC & Company Registration Services | Taxvio",
  numberOfItems: DELHI_AREAS.length,
  itemListElement: DELHI_AREAS.map((c, i) => ({
    "@type": "ListItem",
    position: i + 1,
    name: `${c.name} — ROC Services`,
    url: `https://www.taxvio.in/state/delhi/roc/${slugifyArea(c.name)}`,
  })),
};
...
function MajorAreaCard({ name, district, region }: { name: string; district: string; region: string }) {
  return (
    <Link href={`/state/delhi/roc/${slugifyArea(name)}`}
      aria-label={`ROC services in ${name}, Delhi`}
...
/* ─── Page ─────────────────────────────────────────────────────────────────── */
export default function DelhiROCIndexPage() {
  return (
    <>
      <Script id="delhi-roc-schema" type="application/ld+json"
      ...
      <main className="bg-[#f8fbfd] text-gray-800 font-sans">
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-10 md:pt-28 md:pb-14">
            <nav className="mb-8">
              <ol className="flex items-center gap-2 text-xs text-white/50">
                ...
                <li className="text-white/70 font-medium">ROC & Company Registration — Delhi</li>
              </ol>
            </nav>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold mb-6 backdrop-blur-sm"
                  ...
                  Delhi · 300+ Areas · ROC / MCA · 100% Online
                </div>
                ...
                <p className="mt-5 text-white/75 text-base md:text-lg leading-relaxed max-w-xl">
                  ...
                  authorised capital increase &amp; company closure across{" "}
                  <strong className="text-white">{DELHI_AREAS.length}+</strong> Delhi neighbourhoods.
                  CA-assisted, starting <strong className="text-sky-300">₹3,999</strong>.
                </p>

                <div className="mt-8 grid grid-cols-3 gap-3">
                  {[
                    { val: `${DELHI_AREAS.length}+`, label: "Delhi Areas Covered", icon: Globe },
                    { val: "3,100+", label: "Companies Formed",    icon: Building2 },
                    { val: "₹3,999",  label: "Starting Price",     icon: TrendingUp },
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3">
                  <a href="https://wa.me/918937980366?text=Hello%20Taxvio%2C%20I%20need%20ROC%20help%20in%20Delhi."
              ...
              <div className="hidden md:block">
                <p className="text-xs uppercase tracking-widest text-white/40 font-bold mb-4">ROC services in every Delhi area</p>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <h2 className="text-xl md:text-2xl font-extrabold text-gray-800">ROC Services in Key Delhi Areas</h2>
              </div>
            </div>
        ...
        <section className="py-12 bg-white border-y border-gray-100">
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="text-[11px] font-bold uppercase tracking-widest text-violet-600">Established Localities</p>
                <h2 className="text-xl font-extrabold text-gray-800">Company Registration in Delhi Residential & Commercial Areas</h2>
              </div>
            </div>
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
              {TIER2_AREAS.slice(0, 30).map((c) => (
                <Link key={c.name} href={`/state/delhi/roc/${slugifyArea(c.name)}`}
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-[#00416a] mt-4">
                ROC Services — All Delhi Areas by District
              </h2>
            </div>
        ...
        <section className="py-20 bg-white border-y border-gray-100">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-[#00416a] mt-4">
                All ROC Services Available Across Every Delhi Area
              </h2>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5">
              {[
                { title:"Private Limited Company Formation", price:"₹7,999", href:"/serviceslist/roc/private-limited-formation", icon:"🏢", color:"bg-blue-50 border-blue-100",
                  points:["Name approval & MOA/AOA drafting", "SPICe+ filing — DIN, DSC, PAN/TAN", "Certificate of Incorporation in 7–10 days", "RoC Delhi jurisdiction"] },
                { title:"LLP Registration", price:"₹6,999", href:"/serviceslist/roc/llp-formation", icon:"🤝", color:"bg-violet-50 border-violet-100",
                  points:["Name reservation on MCA portal", "LLP agreement drafting", "DPIN & DSC for designated partners", "Incorporation certificate issuance"] },
                { title:"OPC Registration", price:"₹6,999", href:"/serviceslist/roc/opc-formation", icon:"👤", color:"bg-emerald-50 border-emerald-100",
                  points:["Single-member company structure", "MOA & AOA drafting for OPC", "Nominee director consent (INC-3)", "Incorporation certificate"] },
                { title:"Section 8 Company Registration", price:"₹10,999", href:"/serviceslist/roc/section-8-company", icon:"💚", color:"bg-teal-50 border-teal-100",
                  points:["Name approval & object clause drafting", "MOA & AOA for non-profit objectives", "Section 8 licence application", "No minimum capital requirement"] },
                { title:"Annual ROC Compliance", price:"₹4,999", href:"/serviceslist/roc/annual-roc-compliance", icon:"📅", color:"bg-amber-50 border-amber-100",
                  points:["AOC-4 (financial statements) filing", "MGT-7 (annual return) filing", "LLP Form 11 & Form 8", "Board & AGM minute drafting"] },
                { title:"Director Appointment / Resignation", price:"₹2,499", href:"/serviceslist/roc/director-appointment-resignation", icon:"🔄", color:"bg-sky-50 border-sky-100",
                  points:["DIR-12 filing within 30 days", "Board resolution drafting", "DIN application for new directors", "MCA approval tracking"] },
                { title:"Company Name Change", price:"₹4,999", href:"/serviceslist/roc/company-name-change", icon:"✏️", color:"bg-rose-50 border-rose-100",
                  points:["Name availability check (RUN)", "EGM special resolution & MGT-14", "MOA & AOA alteration (INC-24)", "Fresh Certificate of Incorporation"] },
                { title:"Increase Authorised Capital", price:"₹3,499", href:"/serviceslist/roc/authorized-capital-increase", icon:"📈", color:"bg-indigo-50 border-indigo-100",
                  points:["SH-7 filing with RoC Delhi", "MOA alteration (Capital Clause)", "Board & EGM resolution drafting", "Updated capital structure"] },
                { title:"Company Closure / Strike Off", price:"₹5,999", href:"/serviceslist/roc/company-closure", icon:"🔒", color:"bg-gray-50 border-gray-100",
                  points:["STK-2 (Fast Track Exit) filing", "Statement of accounts — nil liabilities", "Indemnity bond & affidavit prep", "Closure certificate from RoC Delhi"] },
        ...
        <section className="py-16 bg-[#00416a]">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-10">
              <h2 className="text-2xl font-extrabold text-white">All Delhi Areas — ROC & Company Registration</h2>
              <p className="text-white/55 text-sm mt-2">Click your area for dedicated company formation & ROC compliance services</p>
            </div>
              ...
              <div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="flex-1">
                  ...
                  <h2 className="text-2xl md:text-3xl font-extrabold text-white leading-tight">
                    Company Registration & ROC — Wherever You Are in Delhi
                  </h2>
                  <p className="text-white/65 text-sm mt-3 max-w-lg leading-relaxed">
                    100% online. Same-day WhatsApp response. Our CA team serves every Delhi area. Private Ltd, LLP, OPC, annual ROC compliance starting ₹3,999.
                  </p>
                </div>
