// app/state/delhi/gst-services/[city]/page.tsx
...
export async function generateMetadata(
  ...
  return {
    title: `GST Registration & Return Filing in ${areaName}, Delhi | Taxvio`,
    description: `Expert GST registration, GSTR-1/GSTR-3B filing, GST refund, LUT filing, GSTIN verification, e-commerce GST and freelancer GST in ${areaName}, ${district}, Delhi. CA-assisted, 100% online, starting ₹1,499. Get your GSTIN in 3–7 days.`,
    keywords: [
      `GST registration ${areaName}`,
      `GST return filing ${areaName} Delhi`,
      `GSTIN ${areaName} ${district}`,
      `GST consultant ${areaName} Delhi`,
      `GST refund ${areaName}`,
      `GST for e-commerce ${areaName}`,
      `GST for freelancers ${areaName}`,
      `GSTIN verification ${areaName}`,
      `online GST ${areaName} Delhi`,
      `CA GST services ${district}`,
    ],
    alternates: { canonical: `https://www.taxvio.in/state/delhi/gst-services/${city}` },
    openGraph: {
      title: `GST Services in ${areaName}, Delhi | Taxvio`,
      description: `GST registration, GSTR filing, refund, LUT, e-commerce & freelancer GST in ${areaName}, ${district}, Delhi — CA-assisted, from ₹1,499.`,
      url: `https://www.taxvio.in/state/delhi/gst-services/${city}`,
      siteName: "Taxvio",
      type: "website",
    },
    twitter: { card: "summary_large_image", title: `GST Services in ${areaName}, Delhi | Taxvio` },
  ...
  return [
    ...
    /* ── 1. GST Registration ── */
    {
      ...
      features: [
        ...
        "All Delhi GST ward jurisdictions covered",
      ],
      seoContent: `GST registration is mandatory in ${areaName}, ${district}, Delhi for any business whose annual turnover crosses ₹40 lakh (goods) or ₹20 lakh (services), or that supplies goods/services interstate, sells through e-commerce marketplaces, or falls under any notified category — regardless of turnover. Taxvio provides complete GST registration for businesses in ${areaName} with GSTIN typically issued within 3–7 working days.

A registered GSTIN allows your ${areaName} business to legally charge GST on invoices, claim Input Tax Credit on business purchases, and be eligible for B2B contracts that require tax invoices. Without it, you cannot issue GST-compliant invoices, and any B2B buyer purchasing from you cannot claim ITC — a serious commercial disadvantage in Delhi's largely B2B-driven trade and services economy.
...
Whether your ${areaName} business is a small retail shop, a wholesale trading firm, or a growing services company, our reconciliation-first approach to GST return filing means fewer notices, accurate ITC claims, and a clean compliance history — which matters directly for loan eligibility, government tenders, and vendor onboarding with larger corporate buyers across Delhi.`,
    },
...
For ${areaName} businesses with annual turnover exceeding ₹5 crore, GSTR-9C — a reconciliation statement comparing audited financial statements against GSTR-9 figures, certified by a Chartered Accountant — is additionally mandatory. Late filing of GSTR-9 attracts a penalty of ₹200 per day (₹100 each under CGST and SGST), capped at 0.25% of turnover in the relevant state — making timely filing a meaningful cost-avoidance exercise, not just a compliance formality.`,
    ...
    /* ── 9. GST Notice Reply ── */
    {
      ...
      seoContent: `GST notices are increasingly common for businesses in ${areaName}, ${district}, Delhi as the department's data analytics flag discrepancies between filed returns — and the most frequent type, ASMT-10 (scrutiny notice), is typically issued for mismatches between GSTR-1 and GSTR-3B, excess ITC claimed beyond what GSTR-2B shows as eligible, or turnover reported in GST returns not matching income tax or e-way bill data. Responding within the 30-day window is critical: ignoring an ASMT-10 leads to assessment under Section 62, resulting in a best-judgement tax demand that is significantly harder to contest after the fact.
...
For ${areaName} businesses that are themselves e-commerce operators (not just sellers) — including platforms facilitating other sellers' transactions — we handle GSTR-8 filing, the specific return for TCS collected and deposited. We also advise restaurant and food businesses in ${areaName} on Section 9(5) compliance, under which platforms like Zomato and Swiggy are deemed the supplier for GST purposes on certain restaurant services, shifting tax liability and invoicing responsibility in ways that frequently confuse new sellers onboarding to these platforms.`,
    ...
    /* ── 13. GST for Freelancers & Independent Professionals ── */
    {
      ...
      seoContent: `${areaName}, in Delhi's dense freelance and independent-professional economy, hosts a large population of software developers, designers, content writers, consultants, and digital marketers — many of whom are unaware that GST registration becomes mandatory once aggregate annual turnover (including domestic and export billing) exceeds ₹20 lakh, even when most or all income comes from foreign clients. A common and costly misconception among ${areaName} freelancers is believing that billing only foreign clients exempts them from GST registration — it does not; it only changes how GST is applied (zero-rated, with LUT, rather than charged to the client).
...
/* ─── Page ──────────────────────────────────────────────────────────────── */
export default async function DelhiGSTAreaPage(
  { params }: { params: Promise<{ city: string }> }
) {
  const { city }  = await params;
  ...
  const WA = `https://wa.me/${PHONE}?text=${encodeURIComponent(`Hello Taxvio, I need GST services in ${areaName}, ${district}, Delhi.`)}`;
  ...
  const localBusinessSchema = {
    ...
    description: `Taxvio provides GST registration, GSTR-1/GSTR-3B filing, refund, LUT, e-commerce GST and freelancer GST services in ${areaName}, ${district}, Delhi.`,
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "GST Delhi",  item: "https://www.taxvio.in/state/delhi/gst-services" },
      { "@type": "ListItem", position: 3, name: district,     item: `https://www.taxvio.in/state/delhi/gst-services#${district.toLowerCase()}` },
      { "@type": "ListItem", position: 4, name: `${areaName} GST`, item: `https://www.taxvio.in/state/delhi/gst-services/${city}` },
    ],
  };
  ...
  const serviceListSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: `GST Services in ${areaName}, Delhi`,
    numberOfItems: services.length,
    itemListElement: services.map((s, i) => ({
      "@type": "ListItem",
      position: i + 1,
      name: s.title,
      url: `https://www.taxvio.in/state/delhi/gst-services/${city}#${s.slug}`,
    })),
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: `How long does GST registration take in ${areaName}, Delhi?`,
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-16 pb-10 md:pt-24 md:pb-14">
            ...
            <nav className="mb-7">
              <ol className="flex flex-wrap items-center gap-1.5 text-xs text-white/45">
                {[
                  { href: "/", label: "Home" },
                  { href: "/state/delhi/gst-services", label: "GST — Delhi" },
            ...
            <div className="grid md:grid-cols-[1fr_300px] gap-10 items-start">
              ...
              <div>
                <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold mb-5 backdrop-blur-sm"
                  ...
                  {areaName}, {district} · Delhi · GST Services
                </div>
        ...
        <section className="py-20 bg-white border-y border-gray-100">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                { icon: Users,       title: "CA-Certified GST Professionals", desc: `Every GST service for ${areaName} businesses is handled by practising CAs — not data entry agents. We understand Delhi GST ward jurisdiction and processing patterns for ${district}.`, color: "bg-blue-100 text-blue-700" },
        ...
        <section className="py-16 bg-white border-b border-gray-100">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="space-y-3" itemScope itemType="https://schema.org/FAQPage">
              {[
                {
                  q: `How long does GST registration take in ${areaName}, Delhi?`,
            ...
            <div className="max-w-6xl mx-auto px-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <h2 className="text-lg font-extrabold text-gray-800">GST Services in Nearby Delhi Areas</h2>
                </div>
              </div>
              <div className="flex flex-wrap gap-3">
                ...
                <Link href="/state/delhi/gst-services"
