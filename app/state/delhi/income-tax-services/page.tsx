// app/state/delhi/income-tax-services/page.tsx
...
export const metadata: Metadata = {
  title: "Income Tax Return Filing & ITR Services Across Delhi | Taxvio",
  description:
    "Taxvio provides expert ITR filing for salaried, proprietors, firms & companies; TDS/TCS returns; income tax audit; income tax scrutiny reply; 12A/80G registration; PAN/TAN; and Form 15G/15H across 300+ areas in Delhi — Connaught Place, Karol Bagh, Nehru Place, Dwarka, Rohini, Saket & more. CA-assisted, 100% online, starting ₹699.",
  keywords: [
    "income tax return filing Delhi",
    "ITR filing Delhi areas",
    "income tax consultant Delhi",
    "TDS return filing Delhi",
    "income tax audit Delhi",
    "PAN card Delhi",
    "TAN application Delhi",
    "12A 80G registration Delhi",
    "income tax scrutiny notice Delhi",
    "Taxvio Delhi income tax",
  ],
  alternates: { canonical: "https://www.taxvio.in/state/delhi/income-tax-services" },
  openGraph: {
    title: "Income Tax Services Across 300+ Delhi Areas | Taxvio",
    description: "Expert ITR filing, TDS/TCS returns, income tax audit, scrutiny reply & 12A/80G across all Delhi areas — CA-assisted, from ₹699.",
    url: "https://www.taxvio.in/state/delhi/income-tax-services",
    siteName: "Taxvio",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Income Tax Services Across Delhi | Taxvio",
    description: "ITR filing, TDS returns, audit & scrutiny reply across 300+ Delhi areas — from ₹699.",
  },
...
const SEO_SECTIONS = [
  {
    heading: "Income Tax Return Filing Services Across Delhi",
    body: `Delhi has one of India's highest concentrations of individual and corporate taxpayers — spanning salaried professionals in government and private sector employment across South Delhi and New Delhi, wholesale traders and proprietors in Karol Bagh and Sadar Bazar, IT and consulting firms clustered around Nehru Place and Saket, and a vast small-business and freelance economy spread across all eleven districts. Income tax compliance needs in Delhi vary significantly by area — a salaried professional in Greater Kailash has very different filing needs from a wholesale trader in Chandni Chowk or a freelance consultant in Hauz Khas.

Taxvio provides comprehensive income tax return filing across all 300+ areas of Delhi — from premium commercial districts like Connaught Place and Nehru Place, to established residential neighbourhoods like Rohini, Janakpuri, and Mayur Vihar, down to outer localities like Najafgarh, Burari, and Mundka. Our CA team handles every ITR category — ITR-1/ITR-2 for salaried individuals, ITR-3/ITR-4 for proprietors and professionals, ITR-5 for firms and LLPs, and ITR-6/ITR-7 for companies and trusts — with deep familiarity of Delhi's specific income tax ward and circle jurisdictions.`,
  },
  {
    heading: "TDS Compliance, Tax Audit & Scrutiny Defence for Delhi Businesses",
    body: `Delhi's dense business and employer landscape generates an enormous volume of TDS obligations — every employer with salaried staff, every firm paying contractors or professionals, and every business making specified payments above notified thresholds must deduct TDS and file quarterly returns. With Delhi housing a high density of TAN holders across corporate offices, trading firms, and professional practices, accurate quarterly TDS/TCS filing (Form 24Q, 26Q, 27Q, 27EQ) is one of the most frequent and high-stakes compliance obligations our Delhi clients face.

Taxvio's tax audit service covers Delhi businesses crossing the Section 44AB thresholds — turnover above ₹1 crore (₹10 crore for 95%+ digital transactions) for business, or ₹50 lakh gross receipts for professionals — handling the complete audit, Form 3CD preparation across all 41 clauses, and timely e-filing. For Delhi taxpayers facing income tax scrutiny — Section 143(1) intimations, 143(2) detailed scrutiny, or 148 reassessment notices — our team provides structured notice analysis, documented replies, and personal representation before the jurisdictional Assessing Officer.`,
  },
  {
    heading: "Why Delhi Taxpayers Across Every District Choose Taxvio",
    body: `Delhi's income tax landscape spans an extraordinary range of taxpayer profiles — senior government employees in Lutyens' Delhi and Chanakyapuri, corporate executives in Nehru Place's office towers, small traders in Sadar Bazar and Karol Bagh's wholesale markets, freelance professionals in South Delhi's startup corridors, and NGOs and trusts operating across the capital's extensive civil society sector. Each segment has distinct deduction opportunities, compliance triggers, and risk areas that a one-size-fits-all approach to ITR filing simply misses.

Taxvio's CA team has filed returns and handled notices for clients across nearly every Delhi income tax ward — from the Karol Bagh circle to the South Delhi and Dwarka jurisdictions — giving us practical familiarity with local Assessing Officer query patterns and processing timelines. Our WhatsApp-first model means a salaried employee in Rohini and a trust administrator in Mehrauli receive the exact same CA-quality, same-day response, with transparent upfront pricing and zero office visits required for any of our 13 income tax services.`,
  },
];
...
const itemListSchema = {
  ...
  "@type": "ItemList",
  name: "Delhi Areas — Income Tax Services | Taxvio",
  numberOfItems: DELHI_AREAS.length,
  itemListElement: DELHI_AREAS.map((c, i) => ({
    "@type": "ListItem",
    position: i + 1,
    name: `${c.name} — Income Tax Services`,
    url: `https://www.taxvio.in/state/delhi/income-tax-services/${slugifyArea(c.name)}`,
  })),
};
...
function MajorAreaCard({ name, district, region }: { name: string; district: string; region: string }) {
  return (
    <Link href={`/state/delhi/income-tax-services/${slugifyArea(name)}`}
      aria-label={`Income tax services in ${name}, Delhi`}
...
/* ─── Page ─────────────────────────────────────────────────────────────────── */
export default function DelhiIncomeTaxIndexPage() {
  return (
    <>
      <Script id="delhi-it-schema" type="application/ld+json"
      ...
      <main className="bg-[#f8fbfd] text-gray-800 font-sans">
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-10 md:pt-28 md:pb-14">
            <nav className="mb-8">
              <ol className="flex items-center gap-2 text-xs text-white/50">
                ...
                <li className="text-white/70 font-medium">Income Tax Services — Delhi</li>
              </ol>
            </nav>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold mb-6 backdrop-blur-sm"
                  ...
                  Delhi · 300+ Areas · Income Tax Only · 100% Online
                </div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3">
                  <a href="https://wa.me/918937980366?text=Hello%20Taxvio%2C%20I%20need%20income%20tax%20help%20in%20Delhi."
              ...
              <div className="hidden md:block">
                <p className="text-xs uppercase tracking-widest text-white/40 font-bold mb-4">Income tax services in every Delhi area</p>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <h2 className="text-xl md:text-2xl font-extrabold text-gray-800">Income Tax Services in Key Delhi Areas</h2>
              </div>
            </div>
        ...
        <section className="py-12 bg-white border-y border-gray-100">
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="text-[11px] font-bold uppercase tracking-widest text-blue-600">Established Localities</p>
                <h2 className="text-xl font-extrabold text-gray-800">ITR Filing in Delhi Residential & Commercial Areas</h2>
              </div>
            </div>
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
              {TIER2_AREAS.slice(0, 30).map((c) => (
                <Link key={c.name} href={`/state/delhi/income-tax-services/${slugifyArea(c.name)}`}
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-[#00416a] mt-4">
                Income Tax Services — All Delhi Areas by District
              </h2>
            </div>
        ...
        <section className="py-20 bg-white border-y border-gray-100">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold text-[#00416a] mt-4">
                All Income Tax Services Available Across Every Delhi Area
              </h2>
        ...
        <section className="py-16 bg-[#00416a]">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-10">
              <h2 className="text-2xl font-extrabold text-white">All Delhi Areas — Income Tax Services</h2>
              ...
              <div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="flex-1">
                  ...
                  <h2 className="text-2xl md:text-3xl font-extrabold text-white leading-tight">
                    ITR Filing & Tax Services — Wherever You Are in Delhi
                  </h2>
                  <p className="text-white/65 text-sm mt-3 max-w-lg leading-relaxed">
                    100% online. Same-day WhatsApp response. Our CA team serves every Delhi area — Connaught Place to Najafgarh. Starting ₹699.
                  </p>
                </div>
